            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tbody><tr>
                    ...
                    <td width="90%" style="background-color: #ffffff; padding: 35px;">
                        ...
                        <p style="color: #000000;">You try to withdraw you. Please confurm by link: <a href="<?= Yii::app()->params->currentUrl.'api/gateway/confurmWithdraw?user='.$user.'&code='.$code ?>"><?= Yii::app()->params->currentUrl.'api/gateway/confurmWithdraw?user='.$user.'&code='.$code ?></p>
                        <p style="color: #000000;">If it were not you, please contact us immediately.</p>
