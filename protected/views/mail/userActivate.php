            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tbody><tr>
                    ...
                    <td width="90%" style="background-color: #ffffff; padding: 35px;">
                        ...
                        <p style="color: #000000;">Confirmation link:<br><a href="<?= Yii::app()->params->currentUrl.'auth/user/activate/'.$confirmCode?>" style="color: #0f88a5;"><?= Yii::app()->params->currentUrl.'auth/user/activate/'.$confirmCode?></a></p>
