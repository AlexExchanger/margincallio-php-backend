...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable" width="100%">
    <tbody><tr>
        <td valign="top" style="background-color: #04708b">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tbody><tr>
                    ...
                    <td width="90%" style="background-color: #ffffff; padding: 35px;">
                        ...
                        <p style="color: #000000;">You just used the "Lost password" option. Please click the link below to change your current password:</p>
                        <p style="color: #000000;">Link:<br><a href="<?= Yii::app()->params->currentUrl.'auth/user/changePassword/'.$confirmCode?>" style="color: #0f88a5;"><?= Yii::app()->params->currentUrl.'auth/user/changePassword/'.$confirmCode?></a></p>
